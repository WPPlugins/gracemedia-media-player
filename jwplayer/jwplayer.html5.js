...
(function (c) {
    ...
    b.defaults = {
        prefix: "",
        file: "data:image/png;base64,",
        linktarget: "_top",
        margin: 8,
        hide: false,
        position: "top-right"
...
(function (e) {
    var l = jwplayer.utils,
        j = l.css,
        a = "About GraceMedia Player ",
        m = "http://www.gracemedia.tv/",
        k = document,
        h = ".jwclick",
        g = h + "_item",
        f = "100%",
    ...
    e.rightclick = function (r, p) {
        var x = r,
            q, w = l.extend({
                aboutlink: "http://www.gracemedia.tv/",
                abouttext: a + "(1.0)"
            }, p),
            n = false,
            y, s;
